...
# Creating a game window, initializing pygame, and making a clock variable for FPS
WIDTH = 288
HEIGHT = 512
...
# Importing image for the floor
floor = pygame.image.load('assets/base.png').convert()
floor_x_possition = 0

# Importing assets for bird and making a rectangle around it
...
# Importing image for the pipes and making it spawn automatically
...
# Importing image for "Game Over" screen
...
# Importing sounds (Flapping, Collisions, Points)
